  ...
  return (
    <div className='App'>
      ...
      <section className='Introduction'>
        ...
        <p>
          Welcome to quick dash, our aim is to help you improve your typing
          workflow. Our primary function is to insert dashes inbetween spaces in
          a title/sentence. Great for long URLs. We have also added additional
          features which helps journalists, content editors, copywriters and
          authors with their workflow.
        </p>
      </section>
      ...
      <section className='Benefits'>
        <div className='Benefits__ContentBox'>
          ...
          <h5>Easy To Use</h5>
          <p>Simple and clear user-friendly interface</p>
        </div>

        <div className='Benefits__ContentBox'>
          <img src={FastToUse} alt='' />
          <h5>Fast to Use</h5>
          <p>Instant response, No download required.</p>
        </div>
        <div className='Benefits__ContentBox'>
          <img src={ImproveWorkflow} alt='' />
          <h5>Improves Workflow.</h5>
          <p>Speeds up workflow, reducing typing.</p>
        </div>
      </section>
      ...
      <section className='Footer'>
        <p>© QuickDash 2019</p>
        <p>
          An Application By Stefan Trinh |{' '}
          <a href='https://www.stefantrinh.com'>stefantrinh.com</a>
        </p>
        ...
        <li>
          <a href='https://www.journalofz.com'>Journal of Z</a>
        </li>
        <li>
          <a href='https://www.kassiella.com'>[ kassiella ]</a>
        </li>

        <br />
        <span>
          <b>
            <u>Pending Features/Functions</u>
          </b>
        </span>
